...
const BackgroundVerificationForm = () => {
    ...
    const handleBlur = async (e, servicetable, serviceIndex) => {
        ...
        console.log('changedKeysss', changedKey)
    ...
    console.log('setCheckedData', checkedData)
    console.log('serviceData', serviceData)
    return (
        <>
            {
                            ...
                            </div>
                            {
                                serviceData?.length > 0 ? (
                                    serviceData.map((serviceArr, serviceIndex) => {
                                        ...
                                        const inputData = serviceArr?.data || {};
                                        console.log('inputData', inputData) // Add fallback to empty object if data is null or undefined
                                        return (
                                            <div
                                                key={serviceIndex}
                                                                                        ...
                                                                                        {input.type === "checkbox" && (
                                                                                            <div className="flex items-center space-x-3">
                                                                                                <input
                                                                                                    ...
                                                                                                    type="checkbox"
                                                                                                    name={input.name}
                                                                                                    checked={inputData?.[input.name] || false} // Force checked when row is hidden
