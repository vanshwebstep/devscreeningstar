...
const ClientManagementData = () => {
    ...
    const fetchServices = useCallback(async () => {
        ...
        try {
            ...
            const res = await fetch(`https://devscreeningnode.onrender.com/Screeningstar/service`, {
                headers: {
    ...
    const fetchPackages = useCallback(async () => {
        ...
        try {
            ...
            const res = await fetch(`https://devscreeningnode.onrender.com/Screeningstar/package`, {
                headers: {
                    'Authorization': `Bearer ${storedToken}`,
                },
            });
