...
const VendorBulk = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                "http://localhost:5000/internal-storage/vendor/bulk/create",
                {
                    method: "POST",
            ...
            if (response.ok && result.status) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        navigate("/admin-Vendors");  // Replace with your route
                    }
                });
    ...
    const csvData = `vendor_name,registered_address,authorized_person_name,authorized_person_designation,mobile_number,email_id,spoc_name,spoc_designation,service_presence,pricing,turnaround_time,standard_process,vendor_status,remarks
VeriFast Services,"12 Tech Park, Pune",Neha Sharma,Director,9012345678,neha@verifast.com,Rohan Mehta,Support Lead,PAN India,₹400,3 Days,Standard,Active,Reliable vendor
QuickCheck Pvt Ltd,"88 Business Hub, Hyderabad",Karan Patel,CEO,9023456781,karan@quickcheck.com,Sneha Iyer,Client Manager,South India,₹350,2 Days,Customized,Inactive,Needs performance improvement
SecureVerify Solutions,"34 Industrial Area, Chennai",Divya Rao,Manager,9034567892,divya@secureverify.com,Ankit Joshi,Operations Exec,North India,₹500,4 Days,Standard,Active,Consistent results`;
    ...
    const handleDownload = () => {
        ...
        link.href = url;
        link.setAttribute('download', 'VENDOR-SAMPLE.csv');
    ...
    return (
        ...
        <div className="bg-[#c1dff2] border border-black" ref={clientEditRef} id="clientedit" >
            <h2 className="text-2xl font-bold py-3 text-left border-b border-b-black  text-[#4d606b] px-3 border">VENDOR BULK UPLOAD </h2>
