...
const ExistingUsers = () => {
    ...
    const fetchUsers = useCallback(async () => {
        ...
        try {
            const response = await fetch(
                `https://devscreeningnode.onrender.com/admin/list?admin_id=${adminId}&_token=${token}`,
    ...
    const fetchAdminRoleList = useCallback(async () => {
        ...
        try {
            const response = await fetch(`https://devscreeningnode.onrender.com/admin/create-listing?admin_id=${adminId}&_token=${token}`, requestOptions);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(
                "https://devscreeningnode.onrender.com/admin/update",
                requestOptions
            );
    ...
    const handleDelete = useCallback((id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`https://devscreeningnode.onrender.com/admin/delete?id=${id}&admin_id=${admin_id}&_token=${storedToken}`, requestOptions)
