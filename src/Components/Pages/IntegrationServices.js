...
const InactiveClients = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            const url = `https://devscreeningnode.onrender.com/integrated-service/list?admin_id=${adminId}&_token=${token}`;
    ...
    const submitRecords = (type, isEdit) => {
        ...
        const url = isEdit
            ? `https://devscreeningnode.onrender.com/integrated-service/update`
            : `https://devscreeningnode.onrender.com/integrated-service/create`;
    ...
    const submitRecordsBulk = async (type) => {
        ...
        const url = `https://devscreeningnode.onrender.com/integrated-service/create`;
    ...
    const handleApplicationDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const url = `https://devscreeningnode.onrender.com/integrated-service/delete?id=${id}&admin_id=${adminId}&_token=${token}`;
                fetch(url, requestOptions)
                    .then((response) => {
                        if (!response.ok) {
