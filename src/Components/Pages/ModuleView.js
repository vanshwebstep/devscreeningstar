...
const ViewModules = () => {
  ...
  const handleSubmit = async (id) => {
    ...
    const url = `https://devscreeningnode.onrender.com/email-template/module/template/update`;
  ...
  const fetchModuleData = async () => {
    ...
    const url = `https://devscreeningnode.onrender.com/email-template/module/templates?admin_id=${admin_id}&_token=${storedToken}&module=${module}`;
