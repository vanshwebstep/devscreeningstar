...
const VerificationStatus = () => {
    ...
    const fetchData = useCallback((filterStatus = null) => {
        ...
        let baseUrl = `https://devscreeningnode.onrender.com/branch/report-case-status/list?branch_id=${branch_id}&customer_id=${customerId}&_token=${token}`;
    ...
    const fetchServicesData = async (applicationId, servicesList, reportDownload = '0') => {
        ...
        try {
            const baseUrl = `https://devscreeningnode.onrender.com/branch/report-case-status/services-annexure-data`;
