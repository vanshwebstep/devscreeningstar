...
const UserListing = () => {
  ...
  const fetchData = async () => {
    ...
    let url = `https://devscreeningnode.onrender.com/branch/sub-user/list?branch_id=${branch_id}&_token=${branch_token}`;
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('https://devscreeningnode.onrender.com/branch/sub-user/update-email', requestOptions);
  ...
  const handleDelete = async (id) => {
    ...
    let url = `https://devscreeningnode.onrender.com/branch/sub-user/delete?id=${id}&branch_id=${branch_id}&_token=${_token}`;
